...
function CocktailSection() {
    ...
    return (
        <div className="newest-movies p-6 rounded-lg shadow-lg">
            <h3 className="mb-3 heading-text font-bold text-white">🔥 Последно порачани коктели </h3>
            {coctails.map(cocktail => (
                <CoctailCard cocktail={cocktail} key={cocktail.drinkName}/>
            ))}
        </div>
